...
(function () {
   ...
   var grammar = {
      ...
      ParserRules: [{ "name": "PROGRAM$ebnf$1", "symbols": [] }, { "name": "PROGRAM$ebnf$1$subexpression$1", "symbols": ["ln", "LINE"], "postprocess": nth(1) }, { "name": "PROGRAM$ebnf$1", "symbols": ["PROGRAM$ebnf$1", "PROGRAM$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {
         ...
         } }, { "name": "PROGRAM", "symbols": ["LINE", "PROGRAM$ebnf$1"], "postprocess": ([a, b]) => [a, ...b] }, { "name": "LINE$string$1", "symbols": [{ "literal": ":" }, { "literal": ":" }], "postprocess": function joiner(d) {
            return d.join('');
         } }, { "name": "LINE", "symbols": ["NAME", "DECLARATION", "_", "LINE$string$1", "_", "TYPE", "__"], "postprocess": ([name, { path, defaults },,,, [coerceTo]]) => ({ type: 'declaration', name, body: { path: path || name, defaults }, coerceTo }) }, { "name": "NAME", "symbols": ["WORD"], "postprocess": id }, { "name": "DECLARATION$ebnf$1$subexpression$1", "symbols": ["_", { "literal": "=" }, "_", "WORD"], "postprocess": nth(3) }, { "name": "DECLARATION$ebnf$1", "symbols": ["DECLARATION$ebnf$1$subexpression$1"], "postprocess": id }, { "name": "DECLARATION$ebnf$1", "symbols": [], "postprocess": function (d) {
            return null;
         } }, { "name": "DECLARATION$ebnf$2", "symbols": [] }, { "name": "DECLARATION$ebnf$2", "symbols": ["DECLARATION$ebnf$2", "DEFAULT"], "postprocess": function arrpush(d) {
            return d[0].concat([d[1]]);
         } }, { "name": "DECLARATION", "symbols": ["DECLARATION$ebnf$1", "DECLARATION$ebnf$2"], "postprocess": ([path, defaults]) => ({ path, defaults }) }, { "name": "DEFAULT", "symbols": ["_", { "literal": "|" }, "_", "VALUE"], "postprocess": pipe(log, nth(3), ([val]) => option({ val })) }, { "name": "VALUE", "symbols": ["BOOL"] }, { "name": "VALUE", "symbols": ["NUM"] }, { "name": "VALUE", "symbols": ["STR"] }, { "name": "VALUE", "symbols": ["EXPRESSION"] }, { "name": "OPERATOR$string$1", "symbols": [{ "literal": "f" }, { "literal": "i" }, { "literal": "l" }, { "literal": "e" }], "postprocess": function joiner(d) {
            return d.join('');
         } }, { "name": "OPERATOR", "symbols": ["OPERATOR$string$1"], "postprocess": id }, { "name": "EXPRESSION$subexpression$1", "symbols": ["STR"] }, { "name": "EXPRESSION$subexpression$1", "symbols": ["WORD"] }, { "name": "EXPRESSION", "symbols": ["OPERATOR", "_", "EXPRESSION$subexpression$1"], "postprocess": ([operator, _, args]) => ({ type: 'expression', operator, args }) }, { "name": "BOOL", "symbols": [/[Yy]/, /[eE]/, /[sS]/], "postprocess": _true }, { "name": "BOOL", "symbols": [/[nN]/, /[oO]/], "postprocess": _false }, { "name": "BOOL$string$1", "symbols": [{ "literal": "t" }, { "literal": "r" }, { "literal": "u" }, { "literal": "e" }], "postprocess": function joiner(d) {
            return d.join('');
            ...
            return d[0].concat([d[1]]);
         } }, { "name": "__", "symbols": ["__$ebnf$1"], "postprocess": nothing }, { "name": "ln$ebnf$1", "symbols": [{ "literal": "\r" }], "postprocess": id }, { "name": "ln$ebnf$1", "symbols": [], "postprocess": function (d) {
            return null;
