...
var grammar = {
    ...
    {"name": "LINE", "symbols": ["NAME", "DECLARATION", "_", "LINE$string$1", "_", "TYPE", "__"], "postprocess": ([name, {path, defaults} ,,,,[coerceTo] ]) => ({type:'declaration', name, body: { path: (path || name ), defaults }, coerceTo })},
    {"name": "NAME", "symbols": ["WORD"], "postprocess": id},
    {"name": "DECLARATION$ebnf$1$subexpression$1", "symbols": ["_", {"literal":"="}, "_", "WORD"], "postprocess": nth(3)},
    ...
    {"name": "DECLARATION$ebnf$2", "symbols": ["DECLARATION$ebnf$2", "DEFAULT"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "DECLARATION", "symbols": ["DECLARATION$ebnf$1", "DECLARATION$ebnf$2"], "postprocess": ([path, defaults]) => ({ path, defaults })},
    {"name": "DEFAULT", "symbols": ["_", {"literal":"|"}, "_", "VALUE"], "postprocess": pipe( log, nth(3),([val]) => option({val}))},
